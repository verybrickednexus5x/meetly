...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Create an event, share a code, and let Meetly find the perfect time everyone is free." },
      { property: "og:title", content: "Meetly — Plan hangouts with friends" },
      { property: "og:description", content: "Share a code, collect availability, get the best time to meet." },
